...
public class RucherService {
    ...
    public CompletableFuture<Void> upsertRucheAsync(String uid, String rucherId, Ruches ruche) {
        ...
        // Optionnel : valeurs par défaut des constantes
    ...
    public void upsertRucher(String uid, Ruchers rucher) {
        ...
        // si tu as ajouté un champ "nom" dans le modèle, n’hésite pas à le pousser aussi :
        // data.put("nom", rucher.getNom() != null ? rucher.getNom() : rucherId);

        data.put("createdAt", createdAt);
        data.put("updatedAt", now);

        // ECRITURE (bloquante via ton utilitaire)
