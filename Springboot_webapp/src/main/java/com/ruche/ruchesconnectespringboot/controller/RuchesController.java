...
public class RuchesController {
    ...
    @GetMapping(params = "rucheId")
    public String detailByQueryParam(@PathVariable String rucherId,
                                     @RequestParam String rucheId,
                                     Authentication auth,
                                     Model model) {
        return detail(rucherId, rucheId, auth, model); // réutilise ta méthode détail existante
    }

    @PostMapping("/{rucheId}/constants/notify")
    public String setNotify(@PathVariable String rucherId,
        ...
        rucherService.setRucheConstantsNotify(uid, rucherId, rucheId, notify);
        return "redirect:/ruchers/" + rucherId + "/ruches/" + rucheId;
    }


    @PostMapping("/{rucheId}/constants")
    public String updateConstants(@PathVariable String rucherId,
                                  @PathVariable String rucheId,
        ...
        rucherService.updateRucheConstants(uid, rucherId, rucheId, temperature, humidity, interval, notify);
        return "redirect:/ruchers/" + rucherId + "/ruches/" + rucheId;
    }
